...
const candidate: AlertCandidate = {
  rule: { id: "r", tenant_id: "default", name: "Switch 2", include_terms_json: "[]", exclude_terms_json: "[]", category: "console", condition_scope: "new", max_price_cents: null, min_used_score: 70, alert_limit: 3, is_paused: 0, deleted_at: null },
  offer: { id: "o", canonicalKey: "console:switch", firstSeenAt: "2026-09-18T00:00:00Z", lastSeenAt: "2026-09-18T00:00:00Z", sourceId: "mercado-livre", externalId: "MLB1", title: "Nintendo Switch 2", description: "Console lacrado com garantia de fábrica e envio imediato.", url: "https://example.test/item", priceCents: 299900, pixPriceCents: 289900, couponText: "RADAR10", shippingText: "frete grátis", condition: "new" },
