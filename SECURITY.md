...
| Disponibilidade | Uma fonte com falha não para as demais. O coletor registra o erro e pausa a fonte diante de CAPTCHA, 401, 403 ou 429. |
...
- Não faça crawling em fonte pendente, pausada, bloqueada ou sem permissão registrada.
- Pare e pause a fonte ao receber CAPTCHA, 401, 403 ou 429. Não tente burlar controles.
- Permita feeds externos somente por HTTPS e com host cadastrado em `AUTHORIZED_FEED_HOSTS`.
